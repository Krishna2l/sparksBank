...
<body style="background-image: url(./images/backgrnd.jpg); background-repeat: no-repeat; background-size: cover;">
<marquee direction="left" hspace = "20" scrollamount = "8" id="marq">KeepSafe Sparks Bank never asks for 
